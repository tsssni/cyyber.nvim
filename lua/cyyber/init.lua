local palette = require('cyyber.palette')
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    Comment        { fg = palette.light_black }, -- Any comment
    ...
    Function       { fg = palette.light_yellow }, --   Function name (also: methods for classes)

    Statement      { fg = palette.light_cyan }, -- (*) Any statement
    ...
    PreProc        { fg = palette.light_magenta }, -- (*) Generic Preprocessor
